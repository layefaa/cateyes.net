...
const FollowEffect = () => {
  return (
      <div className={`group w-fit`}>
        <div className={` items-center gap-[1.6rem] cursor-pointer hidden sm:flex group-hover:hidden w-fit`}>
        ...
        <div className={`hidden  w-fit group-hover:flex`}><Socials dir={'left'} strokeColor={'stroke-white'}/></div>
      </div>
  );
};
