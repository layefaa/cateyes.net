...
const TiktokLink = ({strokeColor}: ISocialIcon) => {
  return (
      ...
      <svg width="20" height="20" className={`${strokeColor} cursor-pointer`} viewBox="0 0 20 20"
           xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="tiktok" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#F22C7E"/>
