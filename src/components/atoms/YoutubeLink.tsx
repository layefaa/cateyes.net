...
const YoutubeLink = ({strokeColor, strokeColor2}: ISocialIcon) => {
  return (
      <svg width="20" className={`${strokeColor} cursor-pointer hover:stroke-[#ff0000] hover:fill-[#ff0000]`}
           height="20"
        ...
        <path d="M8.33325 7.5L12.4999 10L8.33325 12.5V7.5Z"  className={strokeColor2} stroke-width="2" stroke-linecap="round"
